			...
			<div class="wrap-menu-desktop">
				<nav class="limiter-menu-desktop container">
					...
					<div class="wrap-icon-header flex-w flex-r-m">
						...
						<a href="{{route('card.index')}}" class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti " data-notify="{{Cart::count()}}">
							<i class="zmdi zmdi-shopping-cart"></i>
						</a>
						<a href="{{route('videPanier')}}" class="dis-block icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 " >
